...
<head>
    ...
    <title>Orders - Database Penjualan CRUD</title>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        ...
                        <tr>
                            <td>{$tampil['id']}</td>
                            <td>{$tampil['customer_id']}</td>
                            <td>{$tampil['order_date']}</td>
                            <td>{$tampil['shipped_date']}</td>
                            <td>
                                <a href='edit_order.php?id={$tampil['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='delete_order.php?id={$tampil['id']}' class='btn btn-danger btn-sm'>Delete</a>
                            </td>
                        </tr>";
                        $no++;
                    }
